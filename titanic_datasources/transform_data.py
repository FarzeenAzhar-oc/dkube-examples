def getColNames(df, col):
    """
    Function to  do a case insensitve search for column names in dataframe df 
    ...
    Returns
    -------
        A list/string of column names from dataframe df corresponding to the one(s) given in col
    """
    if type(col) == list:
